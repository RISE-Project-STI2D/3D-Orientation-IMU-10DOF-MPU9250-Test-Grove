...
#define MinimalSerialDebug true
#define SerialDataTimeRate 10
...
void setup()
{
  ...
  Serial.println(F("MPU9250 9-axis motion sensor..."));
  ...
  if (c == 0x71) // WHO_AM_I should always be 0x68
  {
    ...
    Serial.println(F("MPU9250 Self Test:"));
    ...
    Serial.println(F(" Calibrate MPU9250 gyro and accel"));
    accelgyrocalMPU9250(MPU9250gyroBias, MPU9250accelBias); // Calibrate gyro and accelerometers, load biases in bias registers
    Serial.println(F("accel biases (mg)")); Serial.println(1000.*MPU9250accelBias[0]); Serial.println(1000.*MPU9250accelBias[1]); Serial.println(1000.*MPU9250accelBias[2]);
    Serial.println(F("gyro biases (dps)")); Serial.println(MPU9250gyroBias[0]); Serial.println(MPU9250gyroBias[1]); Serial.println(MPU9250gyroBias[2]);
    ...
    Serial.println(F("AK8963 mag biases (mG)")); Serial.println(MPU9250magBias[0]); Serial.println(MPU9250magBias[1]); Serial.println(MPU9250magBias[2]);
  ...
  Serial.println(F("BMP280 Calibration coeficients:"));
  Serial.print(F("dig_T1 ="));
  Serial.println(dig_T1);
  Serial.print(F("dig_T2 ="));
  Serial.println(dig_T2);
  Serial.print(F("dig_T3 ="));
  Serial.println(dig_T3);
  Serial.print(F("dig_P1 ="));
  Serial.println(dig_P1);
  Serial.print(F("dig_P2 ="));
  Serial.println(dig_P2);
  Serial.print(F("dig_P3 ="));
  Serial.println(dig_P3);
  Serial.print(F("dig_P4 ="));
  Serial.println(dig_P4);
  Serial.print(F("dig_P5 ="));
  Serial.println(dig_P5);
  Serial.print(F("dig_P6 ="));
  Serial.println(dig_P6);
  Serial.print(F("dig_P7 ="));
  Serial.println(dig_P7);
  Serial.print(F("dig_P8 ="));
  Serial.println(dig_P8);
  Serial.print(F("dig_P9 ="));
...
void loop()
{
  ...
  delt_t = millis() - count;
  if (delt_t > SerialDataTimeRate) { // update LCD once per half-second independent of read rate
    if (MinimalSerialDebug) {
      Serial.println(F("Acceleration(g) of X,Y,Z:"));
      ...
      Serial.println(F("q0, qx, qy, qz:"));
      Serial.println("q: " + String(q[0]) + " " + String(q[1]) + " "  + String(q[2]) + " " +  String(q[3]));
    }
    if (SerialDebug) {
    ...
    if (SerialDebug) {
      Serial.print(F("MPU9250 Gyro temperature is "));  Serial.print(temperature, 1);  Serial.println(F(" degrees C")); // Print T values to tenths of s degree C
    }
    ...
    if (SerialDebug) {
      ...
      Serial.print(F("Altimeter temperature = "));
      Serial.print( BMP280Temperature, 2);
      Serial.println(F(" C")); // temperature in degrees Celsius
      Serial.print(F("Altimeter temperature = "));
      Serial.print(9.*BMP280Temperature / 5. + 32., 2);
      Serial.println(F(" F")); // temperature in degrees Fahrenheit
      Serial.print(F("Altimeter pressure = "));
      Serial.print(BMP280Pressure, 2);
      Serial.println(F(" mbar"));// pressure in millibar
    ...
    pitch *= 180.0f / PI;
    yaw   *= 180.0f / PI;
    yaw   += 1.8f; // Declination at Danville, California is 13 degrees 48 minutes and 47 seconds on 2014-04-04
    if (yaw < 0) yaw   += 360.0f; // Ensure yaw stays between 0 and 360
    roll  *= 180.0f / PI;
    lin_ax = ax + a31;
    lin_ay = ay + a32;
    ...
    if (SerialDebug) {
      ...
      Serial.print(F("rate = ")); Serial.print((float)sumCount / sum, 2); Serial.println(" Hz");
    }
